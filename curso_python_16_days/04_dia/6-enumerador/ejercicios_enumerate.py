...
for index, valor in enumerate(lista_nombres):
    print(f'{valor} se encuentra en el índice {index}')
...
palabra_lista = list("Python")
lista_indices = list(enumerate(palabra_lista))
print(lista_indices)
