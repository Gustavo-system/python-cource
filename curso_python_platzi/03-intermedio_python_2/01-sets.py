...
# Se declara un set de forma implisita
my_set = {'mexico', 'usa', 'argentina'}
print(my_set)
print(type(my_set))

my_set_two = {'mexico', 'usa', 'argentina', 'usa'}
print(my_set_two)

# Se declarar un set de forma explisita
my_set_explisito = set('Holaa')
print(my_set_explisito)
